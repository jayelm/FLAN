...
class FLANUtilsTest(parameterized.TestCase):
    @parameterized.named_parameters(
        (
            "ZeroshotEvalTaskName",
            utils.ZeroshotEvalTaskName,
            ("foo", 1),
            "foo_type_1",
            ("foo", 1),
        ),
        (
            "ZeroshotScoreEvalTaskName",
            utils.ZeroshotScoreEvalTaskName,
            ("foo", 1),
            "foo_type_1_scoring_eval",
            ("foo", 1),
        ),
        (
            "AllPromptsTaskName",
            utils.AllPromptsTaskName,
            ("foo",),
            "foo_all_prompts",
            "foo",
        ),
        (
            "ZeroshotTemplatedTaskName",
            utils.ZeroshotTemplatedTaskName,
            ("foo", 8),
            "foo_8templates",
            ("foo", 8),
        ),
        (
            "OneshotTemplatedTaskName",
            utils.XshotTemplatedTaskName,
            ("foo", 5, "one"),
            "foo_5templates_one_shot",
            ("foo", 5, "one"),
        ),
        (
            "MultishotTemplatedTaskName",
            utils.XshotTemplatedTaskName,
            ("foo", 5, "multi"),
            "foo_5templates_multi_shot",
            ("foo", 5, "multi"),
        ),
    )
