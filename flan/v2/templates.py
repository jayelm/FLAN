...
PATTERNS = {
    ...
    "record": [
        ...
        (
            "Choose the next sentence." "{passage}\n\n{query}\n\n{options_str}\n\n",
            "{answer}",
        ),
        (
    ...
    "synth_cot_natural_questions": [
        ...
        ("{question}? Let's think step by step.", "{cot}\n\nThe answer is {answer}"),
        (
    ...
    "squad_v2": [
        ...
        (
            ...
            'me (else, reply "unanswerable"): {question}',
            "{answer}",
        ),
        (
        ...
        (
            ...
            'cannot be answered, return "unanswerable")',
            "{answer}",
        ),
        (
        ...
        (
            ...
            'answered, say "unanswerable"): {question}',
            "{answer}",
        ),
    ],
    "drop": [
    ...
    "synth_cot_drop": [
        ...
        ("{context} {question} Chain-of-thought:", "{cot} The answer is {answer}"),
        (
            "{context} {question}\n Let's think step by step:\n",
            "{cot} The answer is {answer}",
        ),
    ...
    "quac": [
        (
            ...
            " a quote from the article: {question}",
            "{answer}",
        ),
        (
    ...
    "definite_pronoun_resolution": [
        ("{sentence}\n\n{options_}\nWho is {pronoun} referring to?", "{answer}"),
        (
    ...
    "glue_qqp": [
        ...
        (
            ...
            "questions 1 and 2 asking the same thing?",
            "{answer}",
        ),
        (
            "Question 1: {question1}\nQuestion 2: {question2}\n{options_}\nWould "
            "the answer to these two questions be the same?",
            "{answer}",
        ),
        (
    ...
    "story_cloze": [
        ("{context}\n{options_}\nWhich option is the next sentence?", "{answer}"),
        ...
        ("{options_}\nWrite a story that ends with: {answer}", "{context} {answer}"),
        (
    ...
    "yelp_polarity_reviews": [
        ...
        ("{options_} What would be an example of an {answer} review?", "{text}"),
    ],
    "arc": [
        ("{question}\n\n{options_}", "{answer}"),
        ("Question: {question}\n{options_}\nAnswer:", "{answer}"),
    ...
    "coqa": [
        ...
        ("{text}\n\n{numbered_questions}\n\nNumbered answers:", "{numbered_answers}"),
        (
    ...
    "opinion_abstracts_rotten_tomatoes": [
        ...
        (
            ...
            "the overall consensus about the movie?",
            "{critic_consensus}",
        ),
        (
    ...
    "e2e_nlg": [
        ...
        (
            ...
            "describes the following attributes of a restaurant.",
            "{target}",
        ),
        (
    ...
    "cot_strategyqa": [
        ...
        ("{question}\nChain of thought:", "{chain_of_thought} The answer is {answer}."),
        (
    ...
    "bigbench:strategyqa.gen.blueridge_vocab.0_shot.1000_examples": [
        ...
        ("Yes or no: {inputs} The answer followed by explanation is:", "{targets}"),
        (
    ...
    "bigbench:sufficient_information.gen.blueridge_vocab.0_shot.39_examples": [
        ...
        ("Question that might not be answerable: {inputs}. Answer:", "{targets}"),
        ("Question: {inputs}\nAnswer:", "{targets}"),
        ("{inputs} A:", "{targets}"),
    ],
    # Not in FLAN Templates (flan_templates):
    ...
    "program_synthesis_dr_repair_error_comments": [
        ...
        (
            "My broken code is below with errors in comments:\n{question}\nThe "
            "fixed code, with no more errors or error comments:",
            "{answer}",
        ),
        (
    ...
    "predict_next_turn_dialog_input_inversion": [
        ...
        ("Write the conversation that led to this response. {answer}", "{dialog_}"),
        ...
        ("If this is the response, what came before? Response {answer}", "{dialog_}"),
    ],
    # Not in FLAN Templates (flan_templates):
...
PATTERNS["qrecc_input_inversion"] = PATTERNS["predict_next_turn_dialog_input_inversion"]
...
PATTERNS["program_synthesis_dr_repair_error_comments_input_inversion"] = PATTERNS[
    "program_synthesis_dr_repair_input_inversion"
]

PATTERNS["cot_input_inversion_gsm8k"] = PATTERNS["cot_stream_general_input_inversion"]
PATTERNS["cot_input_inversion_strategyqa"] = PATTERNS[
    "cot_stream_general_input_inversion"
]
PATTERNS["cot_input_inversion_creak"] = PATTERNS["cot_stream_general_input_inversion"]
PATTERNS["cot_input_inversion_qasc"] = PATTERNS["cot_stream_general_input_inversion"]
PATTERNS["cot_input_inversion_esnli"] = PATTERNS["cot_stream_general_input_inversion"]
PATTERNS["cot_input_inversion_ecqa"] = PATTERNS["cot_stream_general_input_inversion"]
PATTERNS["cot_input_inversion_sensemaking"] = PATTERNS[
    "cot_stream_general_input_inversion"
]
PATTERNS["stream_input_inversion_aqua"] = PATTERNS["cot_stream_general_input_inversion"]
PATTERNS["stream_input_inversion_qed"] = PATTERNS["cot_stream_general_input_inversion"]
...
FEWSHOT_PATTERNS = {
    ...
    "wsc": [
        ...
        FewShotPattern(
            inputs='{context}\nAre "{text1}" and "{text2}" the same? ' "{options_}",
            targets="{answer}",
            inputs_prefix="Q: ",
            targets_prefix="A: ",
            x_y_delimiter="\n=======\n",
    ...
    "yelp_polarity_reviews": [
        ...
        FewShotPattern(
            inputs="What would be an example of an {answer} ({options_}) " "review?",
            targets="{text}",
            inputs_prefix="Problem: ",
            targets_prefix="Answer: ",
            x_y_delimiter="\n\n",
    ...
    "arc": [
        ...
        FewShotPattern(
            inputs="Write a question you would see in a school textbook." " {options_}",
            targets="{question}",
            inputs_prefix="question: ",
            targets_prefix="answer: ",
            x_y_delimiter="\n",
        ...
        FewShotPattern(
            inputs="I just took a test in school today. What question was I " "asked?",
            targets="{question}",
            inputs_prefix="",
    ...
    "qnli": [
        ...
        FewShotPattern(
            inputs='Does "{sentence}" answer the question "{question}" ' "{options_}",
            targets="{answer}",
            inputs_prefix="Problem: ",
            targets_prefix="A: ",
            x_y_delimiter="\n\n",
    ...
    "wnli": [
        ...
        FewShotPattern(
            inputs='If "{sentence1}", does it follow that "{sentence2}"? ' "{options_}",
            targets="{answer}",
            inputs_prefix="Problem: ",
            targets_prefix="Answer: ",
            x_y_delimiter="\n\n",
        ...
        FewShotPattern(
            inputs='If "{sentence1}", is "{sentence2}" ' "correct?\n{options_}",
            targets="{answer}",
            inputs_prefix="Problem: ",
            targets_prefix="Answer: ",
            x_y_delimiter="\n\n",
    ...
    "snli": [
        ...
        FewShotPattern(
            inputs='"{premise}" Does this mean that "{hypothesis}"? ' "{options_}",
            targets="{answer}",
            inputs_prefix="Q: ",
            targets_prefix="A: ",
            x_y_delimiter="\n",
    ...
    "cot_strategyqa": [
        ...
        FewShotPattern(
            inputs="{question}",
            targets="Chain of thought: {chain_of_thought} " "The answer is {answer}.",
            x_y_delimiter="\n\n",
            example_separator="\n\n\n",
            inputs_prefix="[Question]: ",
            targets_prefix="[Answer]: ",
    ...
    "cot_creak": [
        ...
        FewShotPattern(
            inputs="Question: {question}",
            targets="Let me think..... {chain_of_thought} " "The answer is {answer}.",
            x_y_delimiter="\n\n",
            example_separator="\n\n",
            in_template_mix=False,
        ),
        ...
        FewShotPattern(
            inputs="{question}",
            targets="Here's my solution: {chain_of_thought} " "The answer is {answer}.",
            x_y_delimiter="\n",
            example_separator="\n****\n",
            inputs_prefix="[Ques]: ",
            targets_prefix="[Ans]: ",
    ...
    "cot_sensemaking": [
        ...
        FewShotPattern(
            inputs="{question}",
            targets="Thoughts: {chain_of_thought} " "The answer is [{answer}]",
            x_y_delimiter="\n",
            example_separator="\n\n",
            inputs_prefix="q: ",
            targets_prefix="a: ",
    ...
    "unified_qa_science_inst": [
        ...
        FewShotPattern(inputs="Q: {question} ---- {options_}", targets="A: {answer}"),
        FewShotPattern(
            inputs="{question}\n===\n{options_}\n",
            targets="{answer}",
            x_y_delimiter="\n",
    ...
    "predict_next_turn_dialog_input_inversion": [
        ...
        FewShotPattern(
            inputs="See the last examples. Predict the preceding dialog. " "{dialog_}",
            targets="{dialog_}",
            targets_prefix="Preceding conversation: ",
            x_y_delimiter="\n",
            example_separator="\n\n\n",
...
FEWSHOT_PATTERNS[
    "program_synthesis_dr_repair_no_errors_input_inversion"
] = FEWSHOT_PATTERNS["program_synthesis_dr_repair_input_inversion"]
FEWSHOT_PATTERNS[
    "program_synthesis_dr_repair_plain_code_input_inversion"
] = FEWSHOT_PATTERNS["program_synthesis_dr_repair_input_inversion"]
FEWSHOT_PATTERNS[
    "program_synthesis_dr_repair_line_numbers_input_inversion"
] = FEWSHOT_PATTERNS["program_synthesis_dr_repair_input_inversion"]
FEWSHOT_PATTERNS[
    "program_synthesis_dr_repair_error_comments_input_inversion"
] = FEWSHOT_PATTERNS["program_synthesis_dr_repair_input_inversion"]
...
OPT_ITEM_NAME_CANDIDATES = [
    ...
    ["\n " + chr(x) + "). " for x in range(ord("A"), ord("Z") + 1)],  # \n a).
    ["\n " + str(x) + "). " for x in range(1, 27)],  # \n 1).
    [" (" + chr(x) + "). " for x in range(ord("a"), ord("z") + 1)],  #  (A).
    [" (" + chr(x) + "). " for x in range(ord("A"), ord("Z") + 1)],  #  (a).
...
DIALOG_ITEM_NAME_CANDIDATES = [
    ...
    ["\nPerson 1) " if x % 2 == 0 else "\nPerson 2) " for x in range(1000)],
    ["\nPerson A) " if x % 2 == 0 else "\nPerson B) " for x in range(1000)],
    ["\nAnonymous 1) " if x % 2 == 0 else "\nAnonymous 2) " for x in range(1000)],
    ["\nAnonymous A) " if x % 2 == 0 else "\nAnonymous B) " for x in range(1000)],
    ["\n  Person 1) " if x % 2 == 0 else "\n  Person 2) " for x in range(1000)],
    ["\n Person A) " if x % 2 == 0 else "\n Person B) " for x in range(1000)],
    ["\n Anonymous 1) " if x % 2 == 0 else "\n Anonymous 2) " for x in range(1000)],
    ["\n  Anonymous A) " if x % 2 == 0 else "\n  Anonymous B) " for x in range(1000)],
