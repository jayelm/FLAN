...
T0_TRAIN_TASK_SPLITS = {
    ...
    "t0_task_adaptation:ag_news_classify": {"test": 7600, "train": 120000},
    "t0_task_adaptation:ag_news_classify_question_first": {
        "test": 7600,
        "train": 120000,
    },
    "t0_task_adaptation:ag_news_classify_with_choices": {"test": 7600, "train": 120000},
    "t0_task_adaptation:ag_news_classify_with_choices_question_first": {
        "test": 7600,
        "train": 120000,
    },
    "t0_task_adaptation:ag_news_recommend": {"test": 7600, "train": 120000},
    "t0_task_adaptation:ag_news_which_section": {"test": 7600, "train": 120000},
    "t0_task_adaptation:ag_news_which_section_choices": {"test": 7600, "train": 120000},
    ...
    "t0_task_adaptation:app_reviews_categorize_rating_using_review": {"train": 288065},
    "t0_task_adaptation:app_reviews_convert_to_rating": {"train": 288065},
    "t0_task_adaptation:app_reviews_convert_to_star_rating": {"train": 288065},
    "t0_task_adaptation:app_reviews_generate_review": {"train": 288065},
    ...
    "t0_task_adaptation:cos_e_v1.11_i_think": {"train": 9741, "validation": 1221},
    ...
    "t0_task_adaptation:cos_e_v1.11_rationale": {"train": 9741, "validation": 1221},
    ...
    "t0_task_adaptation:quoref_Answer_Test": {"train": 19399, "validation": 2418},
    "t0_task_adaptation:quoref_Context_Contains_Answer": {
        "train": 19399,
        "validation": 2418,
    },
    "t0_task_adaptation:quoref_Find_Answer": {"train": 19399, "validation": 2418},
    ...
    "t0_task_adaptation:quoref_Guess_Answer": {"train": 19399, "validation": 2418},
    "t0_task_adaptation:quoref_Guess_Title_For_Context": {
        "train": 19399,
        "validation": 2418,
    },
    "t0_task_adaptation:quoref_Read_And_Extract_": {"train": 19399, "validation": 2418},
    ...
    "t0_task_adaptation:ropes_plain_bottom_hint": {"train": 10924, "validation": 1688},
    "t0_task_adaptation:ropes_plain_no_background": {
        "train": 10924,
        "validation": 1688,
    },
    "t0_task_adaptation:ropes_prompt_beginning": {"train": 10924, "validation": 1688},
    ...
    "t0_task_adaptation:ropes_prompt_mix": {"train": 10924, "validation": 1688},
    ...
    "t0_task_adaptation:squad_v2_Trivia": {"train": 86821, "validation": 5928},
    ...
    "t0_task_adaptation:trec_fine_grained_ABBR": {"test": 9, "train": 86},
    "t0_task_adaptation:trec_fine_grained_ABBR_context_first": {"test": 9, "train": 86},
    "t0_task_adaptation:trec_fine_grained_DESC": {"test": 138, "train": 1162},
    "t0_task_adaptation:trec_fine_grained_DESC_context_first": {
        "test": 138,
        "train": 1162,
    },
    "t0_task_adaptation:trec_fine_grained_ENTY": {"test": 94, "train": 1250},
    "t0_task_adaptation:trec_fine_grained_HUM": {"test": 65, "train": 1223},
    "t0_task_adaptation:trec_fine_grained_HUM_context_first": {
        "test": 65,
        "train": 1223,
    },
    "t0_task_adaptation:trec_fine_grained_LOC": {"test": 81, "train": 835},
    "t0_task_adaptation:trec_fine_grained_LOC_context_first": {
        "test": 81,
        "train": 835,
    },
    "t0_task_adaptation:trec_fine_grained_NUM": {"test": 113, "train": 896},
    "t0_task_adaptation:trec_fine_grained_NUM_context_first": {
        "test": 113,
        "train": 896,
    },
    "t0_task_adaptation:trec_fine_grained_open": {"test": 500, "train": 5452},
    "t0_task_adaptation:trec_fine_grained_open_context_first": {
        "test": 500,
        "train": 5452,
    },
    "t0_task_adaptation:trec_pick_the_best_descriptor": {"test": 500, "train": 5452},
    "t0_task_adaptation:trec_trec1": {"test": 500, "train": 5452},
    "t0_task_adaptation:trec_trec2": {"test": 500, "train": 5452},
    "t0_task_adaptation:trec_what_category_best_describe": {"test": 500, "train": 5452},
    ...
    "t0_task_adaptation:web_questions_get_the_answer": {"test": 2032, "train": 3778},
    "t0_task_adaptation:web_questions_potential_correct_answer": {
        "test": 2032,
        "train": 3778,
    },
    "t0_task_adaptation:web_questions_question_answer": {"test": 2032, "train": 3778},
    "t0_task_adaptation:web_questions_short_general_knowledge_q": {
        "test": 2032,
        "train": 3778,
    },
    "t0_task_adaptation:web_questions_whats_the_answer": {"test": 2032, "train": 3778},
    ...
    "t0_task_adaptation:wiki_bio_who": {"test": 72829, "train": 582639, "val": 72831},
    ...
    "t0_task_adaptation:yelp_review_full_format_star": {"test": 50000, "train": 650000},
    "t0_task_adaptation:yelp_review_full_on_a_scale": {"test": 50000, "train": 650000},
    "t0_task_adaptation:yelp_review_full_so_i_would": {"test": 50000, "train": 650000},
    "t0_task_adaptation:yelp_review_full_this_place": {"test": 50000, "train": 650000},
}

T0_TRAIN_TASK_METADATA = {
    "t0_task_adaptation:adversarial_qa_dbert_answer_the_following_q": {
        "in_flan": False,
        "seq_len": {"max": 56, "mean": 4},
    ...
    "t0_task_adaptation:ai2_arc_ARC_Challenge_heres_a_problem": {
        "in_flan": True,
        "seq_len": {"max": 1, "mean": 1},
        "task_type": "t0_multiple_choice",
    },
    "t0_task_adaptation:ai2_arc_ARC_Challenge_i_am_hesitating": {
        "in_flan": True,
        "seq_len": {"max": 25, "mean": 4},
        "task_type": "t0_multiple_choice",
    },
    "t0_task_adaptation:ai2_arc_ARC_Challenge_multiple_choice": {
        "in_flan": True,
    ...
    "t0_task_adaptation:app_reviews_generate_review": {
        "in_flan": False,
        "seq_len": {"max": 138, "mean": 22},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:cnn_dailymail_3.0.0_2_or_3_sentences": {
        "in_flan": True,
        "seq_len": {"max": 66, "mean": 42},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:cnn_dailymail_3.0.0_generate_story": {
        "in_flan": True,
        "seq_len": {"max": 391, "mean": 320},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:cnn_dailymail_3.0.0_news_card_view": {
        "in_flan": True,
    ...
    "t0_task_adaptation:dream_answer_to_dialogue": {
        "in_flan": False,
        "seq_len": {"max": 349, "mean": 124},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:dream_baseline": {
        "in_flan": False,
        "seq_len": {"max": 12, "mean": 4},
        "task_type": "t0_multiple_choice",
    },
    "t0_task_adaptation:dream_generate_first_utterance": {
        "in_flan": False,
        "seq_len": {"max": 133, "mean": 14},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:dream_generate_last_utterance": {
        "in_flan": False,
        "seq_len": {"max": 44, "mean": 12},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:dream_read_the_following_conversation_and_answer_the_question": {
        "in_flan": False,
    ...
    "t0_task_adaptation:duorc_ParaphraseRC_answer_question": {
        "in_flan": False,
        "seq_len": {"max": 15, "mean": 2},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:duorc_ParaphraseRC_build_story_around_qa": {
        "in_flan": False,
        "seq_len": {"max": 364, "mean": 334},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:duorc_ParaphraseRC_decide_worth_it": {
        "in_flan": False,
        "seq_len": {"max": 15, "mean": 3},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:duorc_ParaphraseRC_extract_answer": {
        "in_flan": False,
    ...
    "t0_task_adaptation:hellaswag_Open_ended_completion": {
        "in_flan": True,
        "seq_len": {"max": 39, "mean": 12},
        "task_type": "t0_multiple_choice_separated_options",
    },
    "t0_task_adaptation:hellaswag_Open_ended_start": {
        "in_flan": True,
        "seq_len": {"max": 52, "mean": 22},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:hellaswag_Predict_ending_with_hint": {
        "in_flan": True,
    ...
    "t0_task_adaptation:multi_news_distill": {
        "in_flan": True,
        "seq_len": {"max": 339, "mean": 210},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:multi_news_expand_reverse_task_": {
        "in_flan": True,
        "seq_len": {"max": 367, "mean": 254},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:multi_news_summarize": {
        "in_flan": True,
    ...
    "t0_task_adaptation:piqa_Correct_the_solution": {
        "in_flan": True,
        "seq_len": {"max": 99, "mean": 18},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:piqa_Correct_the_solution_if_false_from_sol_1": {
        "in_flan": True,
        "seq_len": {"max": 106, "mean": 25},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:piqa_Correct_the_solution_if_false_from_sol_2": {
        "in_flan": True,
    ...
    "t0_task_adaptation:race_high_Write_a_multi_choice_question_for_the_following_article": {
        "in_flan": False,
        "seq_len": {"max": 75, "mean": 34},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:race_high_Write_a_multi_choice_question_options_given_": {
        "in_flan": False,
        "seq_len": {"max": 20, "mean": 10},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:race_middle_Is_this_the_right_answer": {
        "in_flan": False,
    ...
    "t0_task_adaptation:race_middle_Write_a_multi_choice_question_for_the_following_article": {
        "in_flan": False,
        "seq_len": {"max": 52, "mean": 25},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:race_middle_Write_a_multi_choice_question_options_given_": {
        "in_flan": False,
        "seq_len": {"max": 29, "mean": 9},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:ropes_background_new_situation_answer": {
        "in_flan": False,
    ...
    "t0_task_adaptation:samsum_Write_a_dialogue_that_match_this_summary": {
        "in_flan": True,
        "seq_len": {"max": 366, "mean": 93},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:sciq_Direct_Question": {
        "in_flan": False,
        "seq_len": {"max": 7, "mean": 1},
        "task_type": "t0_multiple_choice_separated_options",
    },
    "t0_task_adaptation:sciq_Direct_Question_Closed_Book_": {
        "in_flan": False,
    ...
    "t0_task_adaptation:social_i_qa_Generate_answer": {
        "in_flan": False,
        "seq_len": {"max": 10, "mean": 3},
        "task_type": "t0_multiple_choice_separated_options",
    },
    "t0_task_adaptation:social_i_qa_Generate_the_question_from_the_answer": {
        "in_flan": False,
        "seq_len": {"max": 9, "mean": 6},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:social_i_qa_I_was_wondering": {
        "in_flan": False,
    ...
    "t0_task_adaptation:wiki_bio_comprehension": {
        "in_flan": False,
        "seq_len": {"max": 273, "mean": 72},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:wiki_bio_guess_person": {
        "in_flan": False,
        "seq_len": {"max": 9, "mean": 2},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:wiki_bio_key_content": {
        "in_flan": False,
    ...
    "t0_task_adaptation:wiki_bio_what_content": {
        "in_flan": False,
        "seq_len": {"max": 84, "mean": 26},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:wiki_bio_who": {
        "in_flan": False,
        "seq_len": {"max": 392, "mean": 92},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:wiki_hop_original_choose_best_object_affirmative_1": {
        "in_flan": False,
    ...
    "t0_task_adaptation:wiki_qa_Direct_Answer_to_Question": {
        "in_flan": False,
        "seq_len": {"max": 69, "mean": 26},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:wiki_qa_Generate_Question_from_Topic": {
        "in_flan": False,
        "seq_len": {"max": 19, "mean": 6},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:wiki_qa_Is_This_True_": {
        "in_flan": False,
    ...
    "t0_task_adaptation:wiqa_what_is_the_final_step_of_the_following_process": {
        "in_flan": False,
        "seq_len": {"max": 26, "mean": 8},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:wiqa_what_is_the_missing_first_step": {
        "in_flan": False,
        "seq_len": {"max": 21, "mean": 7},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:wiqa_what_might_be_the_first_step_of_the_process": {
        "in_flan": False,
    ...
    "t0_task_adaptation:wiqa_which_of_the_following_is_the_supposed_perturbation": {
        "in_flan": False,
        "seq_len": {"max": 7, "mean": 7},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:xsum_DOC_boils_down_to_simple_idea_that": {
        "in_flan": True,
        "seq_len": {"max": 38, "mean": 20},
        "task_type": "t0_question_answer",
    },
    "t0_task_adaptation:xsum_DOC_given_above_write_one_sentence": {
        "in_flan": True,
