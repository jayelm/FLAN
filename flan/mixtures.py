...
for shot_config in few_shot.ShotConfig:
    ...
    all_splits += task_splits.generate_inter_cluster_splits(shot_config=shot_config)

    # Add intra cluster splits.
    all_splits += task_splits.generate_intra_cluster_splits(shot_config=shot_config)

    # Add all overlap split.
    all_splits += [task_splits.generate_all_overlap_split(shot_config=shot_config)]
